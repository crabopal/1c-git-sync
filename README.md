...
- **Выгрузка** — состав (конфигурация и/или расширения) и кнопка «Выгрузить в Git». «Только Git» отправляет уже выгруженные файлы.
- **Загрузка** — замена конфигурации в базе файлами из Git.
